...
namespace FileZillaManager.Repositorio
{
    public class EmpresaRepositorio : FbDataBase.FbRepositorio<Classes.Empresa>
    {
            ...
            : base(new FbDataBase.FbDataBase(Program.ConnectionString()), "EMPRESA")
        {
            ...
            AddField(x => x.DiasApagarAntigos, "DIAS_DEL_ANTIGOS", FbDbType.Integer);
        }
...
@"ALTER TABLE EMPRESA
ADD DIAS_DEL_ANTIGOS INTEGER;",
@"UPDATE EMPRESA SET DIAS_DEL_ANTIGOS = 0 WHERE DIAS_DEL_ANTIGOS IS NULL;",
            };
        }
